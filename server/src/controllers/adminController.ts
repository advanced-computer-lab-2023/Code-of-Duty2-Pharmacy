...
export const getAllPharmacistRegistrationRequests = async (req: Request, res: Response) => {
    try {
        const allPharmacistRegistrationRequests = await PharmacistRegistrationRequest.find();
